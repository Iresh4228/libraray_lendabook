<div class="navbar navbar-inverse set-radius-zero" >
 ...
 <li>
                             ...
                             <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown"> Videos <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="add-video.php">Add Videos</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="manage-video.php">Manage Videos</a></li>
                                </ul>
                            </li>
                           ...
                           <li>
                            ...
                            <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown"> Issue Videos <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="issue-video.php">Issue New Video</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="manage-issued-video.php">Manage Issued Videos</a></li>
                                </ul>
                            </li>
